...
import 'package:hmssdk_flutter_uikit/common/audio_tile.dart';
...
Widget gridAudioView(
  ...
  return GridView.builder(
    ...
    gridDelegate: SliverStairedGridDelegate(
        ...
        pattern: pattern(itemCount, size,padding)),
    physics: const PageScrollPhysics(),
    scrollDirection: Axis.horizontal,
  );
}

List<StairedGridTile> pattern(int itemCount, Size size,EdgeInsets padding) {
